...
// Help
$_['help_address_format']     = 'Voornaam = {firstname}<br />Achternaam = {lastname}<br />Bedrijf = {company}<br />Adres 1 = {address_1}<br />Adres 2 = {address_2}<br />Plaats = {city}<br />Postcode = {postcode}<br />Zone = {zone}<br />Zone Code = {zone_code}<br />Land = {country}';
